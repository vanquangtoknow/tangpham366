...
<form action="index.php" method="post">
	<div class="png search">
		<?php
			...
			if ($button) :
			    if ($imagebutton) :
			        $button = '<input type="image" value="'.$button_text.'" class="png button" src="'.$img.'" onclick="this.form.searchword.focus();"/>';
			    else :
			        $button = '<input type="submit" value="'.$button_text.'" class="png button" onclick="this.form.searchword.focus();"/>';
			    endif;
			endif;
