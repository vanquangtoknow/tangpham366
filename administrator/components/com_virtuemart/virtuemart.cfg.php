...
if ( (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == '443' ) {
	...
	define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/jv-shop/' );
} else {
	define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/jv-shop/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/jv-shop/' );
...
define('DOWNLOADROOT', 'D:\AppServ\www\joomlademo\jvcontopus/');
