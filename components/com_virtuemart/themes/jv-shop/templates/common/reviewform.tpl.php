...
if (!$alreadycommented) {
	...
	<div class="jv-reviewpro" style="width: 100%; clear: both;">
    <h3 class="vmFieldTitle"><?php echo $VM_LANG->_('PHPSHOP_WRITE_REVIEW')  ?></h3>
    <?php echo $VM_LANG->_('PHPSHOP_REVIEW_RATE')  ?>
    ...
    <br />
    <input class="button-big" style="margin-top: 15px;" type="submit" onclick="return( check_reviewform());" name="submit_review" title="<?php echo $VM_LANG->_('PHPSHOP_REVIEW_SUBMIT')  ?>" value="<?php echo $VM_LANG->_('PHPSHOP_REVIEW_SUBMIT')  ?>" />
