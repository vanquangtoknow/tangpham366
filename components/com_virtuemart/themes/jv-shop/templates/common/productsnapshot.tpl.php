...
<div class="jv-product-image">
	<a class="jv-a-img" title="<?php echo $product_name ?>" href="<?php echo $product_link ?>">
		<?php
...
<a class="jv-product-name" title="<?php echo $product_name ?>" href="<?php echo $product_link ?>"><span><?php echo $product_name ?></span></a>
<br/>
<?php
if( !empty($price) ) {
	//echo ('<div class="clear"></div>');
	echo ('<span class="price">Prices: '.$price.'</span>');
	
}
?>
<?php
if( $this->get_cfg( 'showViewDetails', 1 )) {
?>
