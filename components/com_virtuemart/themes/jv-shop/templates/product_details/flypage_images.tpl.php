...
<table border="0" style="width: 100%;">
  <tbody>
	...
	<tr>
	  <td colspan="2">
	  	<a class="buttonask" onclick="protoPop( this.href.replace(/index.php/, 'index2.php' ) + '&only_page=1', { modal: true,width:640,height:480 } );return false;" href="<?php echo $ask_seller_href ?>"><?php echo $ask_seller_text ?></a>
	  </td>
	</tr>
	<tr>
